...
<?php
	...
	$sql="update detail_fasum set id_fasum='$id_fasum', gambar='$gambar', deskripsi='$deskripsi' where id_detail='$id_detail'"; // susun SQL
	$res=mysql_query($sql,$link); // Eksekusi SQL
	if($res){
		//Jika berhasil 
	?> 
		<div class="info">Data detail titik telah diubah.</div> 
	<?php
	} 
	else{
		//Jika gagal
	?> 
		<div class="error">Terjadi kesalahan dalam pengubahan data detail titik baru dengan kesalahan <b><?php echo mysql_error();?></b>. Silahkan diulang lagi.</div>
	<?php
	} 
	?>
