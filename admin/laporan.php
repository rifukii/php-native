...
<div id="main" class="clearfix">
    ...
    <div id="content" role="main">
        <article class="post">
            <h2 class="entry-title"><a href="#">Pilih Jenis Fasum Untuk Membuat Laporan</a></h2><hr />
        ...
        <tbody>
		  ...
		  ?> 
		  	<tr>
               ...
               <td align="center"><a href="laporan_cetak.php?id_jenis=<?php echo $data['id_jenis'];?>"><img src="../images/report.png" border="0"></a></td>
		  	</tr>
		  <?php
		  	} 
		  ?> 
