...
<div id="main" class="clearfix">
    ...
    <div id="content" role="main">
        <article class="post">
            <h2 class="entry-title"><a href="#">Pengubahan Data Kecamatan</a></h2><hr />
...
<?php
	...
	if($res){
	?>
		<div class="info">Data kecamatan <b><?php echo $nama_kecamatan;?></b> telah diubah.</div>
		<?php
	}
	else {
	?>
		<div class="error">Data kecamatan<?php echo $nama_kecamatan;?> gagal diubah dengan pesan kesalahan <b>
