...
<div id="main" class="clearfix">
	...
	$sql="insert into jenis_fasum values(null,trim('$jenis_fasum'),trim('$id_kategori'),trim('$keterangan'),'$icon')"; // susun SQL
	$res=mysql_query($sql,$link); // Eksekusi SQL
	if($res){
		//Jika berhasil 
	?> 
		<div class="info">Jenis fasilitas umum <b><?php echo $jenis_fasum;?></b> telah disimpan</b></div> 
	<?php
	} 
	else{
		//Jika gagal
	?> 
		<div class="error">Terjadi kesalahan dalam penyimpanan jenis fasilitas umum baru dengan kesalahan <b><?php echo mysql_error();?></b>. Silahkan diulang lagi.</div>
	<?php
	} 
	?>
