...
<div id="main" class="clearfix">
    ...
    <div id="content" role="main">
        <article class="post">
            <h2 class="entry-title"><a href="#">Proses Pengubahan Aturan Jarak Fasilitas Umum</a></h2><hr /> 
...
<?php
	...
	$link=koneksi_db();
	$sql="update aturan_jarak set id_aturan_jarak='$id_aturan_jarak', id_jenis='$id_jenis', id_jenis2='$id_jenis2', meter='$meter' where id_aturan_jarak='$id_aturan_jarak'";
	$res=mysql_query($sql);
	if($res){
	?>
