...
<?php 
		...
		$sql="select f.*,j.icon, j.jenis_fasum,a.id_aturan_jarak, a.id_jenis, a.id_jenis2, IFNULL(a.meter,0) AS meter from jenis_fasum j, fasum f LEFT OUTER JOIN aturan_jarak a ON (a.id_jenis2=f.id_jenis) WHERE f.id_jenis=j.id_jenis"; 
